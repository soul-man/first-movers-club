...
{/* 
                                ...
                                <div className="flex flex-wrap flex-row justify-center gap-4 mb-32">
                                    <a 
                                        onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} 
                                        className="group relative flex flex-col items-center mb-20"
                                        ...
                                        <img 
                                            ...
                                            alt='First Mover with ahodl bag'
                                            className="w-[100px] drop-shadow-lg hover:drop-shadow-2xl group-hover:scale-110 duration-300" 
                                        />
                                    ...
                                    <a 
                                        ...
                                        <img 
                                            ...
                                            alt="MintHeaven Logo" 
                                            className="w-[100px] drop-shadow-lg hover:drop-shadow-2xl hover:scale-110 duration-300" 
                                        />
